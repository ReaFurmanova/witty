...
3. The interface must display available dates for booking, sessions for the selected date, open, and booked seats.
When selecting a date and session less than the current time and date archive, they must display data without the possibility of changing it.
